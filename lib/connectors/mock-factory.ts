...
> = {
  googleAds: {
    ...
    account: "GOOGLE ADS / Demo Executive Account",
  ...
  ga4: {
    ...
    account: "GA4 / Demo Executive Account",
  ...
  searchConsole: {
    ...
    account: "SEARCH CONSOLE / Demo Executive Account",
  ...
  bigQuery: {
    ...
    account: "BIGQUERY / Demo Executive Account",
  ...
  cm360: {
    ...
    account: "CM360 / Demo Executive Account",
  ...
  dv360: {
    ...
    account: "DV360 / Demo Executive Account",
  ...
  floodlight: {
    ...
    account: "FLOODLIGHT / Demo Executive Account",
  ...
  crm: {
    ...
    account: "CRM / Demo Executive Account",
